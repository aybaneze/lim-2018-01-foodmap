...
let StringFod =  restCity[i].TipoComida.substring(0,3);
console.log(StringFod);
    if(OptDistrito.value == distrito && OptFood.value == StringFod){ 
     ...
     content.innerHTML+=`<center><div class="w3-container w3-card w3-white w3-round w3-margin" style="width:95%;height:200px;" >
      ...
      else if(OptDistrito.value == distrito && OptFood.value == "tod"){
        content.innerHTML+=`<center><div class="w3-container w3-card w3-white w3-round w3-margin" style="width:95%;height:200px;" >
        <div class="divText"> 
         <p style="font-size:50%;">`+ restCity[i].NomRestaurant+ `</p>
          <p style="font-size:50%;">`+ restCity[i].direccion+ `</p>
...
let OptFood = SelectComida.options[SelectComida.selectedIndex].value;
...
function SeleccionarComida(){
  OptFood= document.getElementById('SelectComida');
  console.log(OptFood.value)
}
